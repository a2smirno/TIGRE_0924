...
imgDTVASDPOCS=AwASD_POCS(noise_projections,geo,angles,50,...
                    'TViter',ng,'maxL2err',epsilon,'alpha',alpha,... % these are very important
                     'lambda',lambda,'lambda_red',lambdared,'Ratio',ratio,'Verbose',verb); % less important.
...
plotImg([head imgASDPOCS DTVASDPOCS] ,'Dim','Z','Step',2,'clims',[0 1],'colormap','magma')
 % error
plotImg(abs([head-head  head-imgASDPOCS head-imgDTVASDPOCS]) ,'Dim','Z','Slice',64,'clims',[0 0.1],'colormap','magma')
